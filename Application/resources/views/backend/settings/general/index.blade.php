            ...
            <div class="card-body">
                <div class="row g-3 mb-2">
                    <div class="col-lg-6">
                        ...
                        <input type="text" name="app_heading_2" class="form-control" value="{{ $appVersion['0']['heading'] }}" required>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="row g-3 mb-2">
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('App Name') }} : <span class="red">*</span></label>
                        <input type="text" name="app_heading_3" class="form-control" value="{{ $appVersion['1']['heading'] }}" required>
                    </div>
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('App Version ') }}</label>
                ...
                <div class="row g-3 mb-2">
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('App Name') }} : <span class="red">*</span></label>
                        <input type="text" name="app_heading_4" class="form-control" value="{{ $appVersion['2']['heading'] }}" required>
                    </div>
                    <div class="col-lg-6">
                        <label class="form-label">{{ __('App Version ') }}</label>
