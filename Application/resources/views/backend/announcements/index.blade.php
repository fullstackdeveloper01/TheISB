                    ...
                    <tr class="item">
                        ...
                        <td>
                            @if($announcement->section == 0)
                                {{ "All" }}
                            @elseif($announcement->section == 1)
                                {{ "A1" }}
                            @elseif($announcement->section == 2)
                                {{ "A2" }}
                            @elseif($announcement->section == 3)
                                {{ "A3" }}
                            @elseif($announcement->section == 4)
                                {{ "A4" }}
                            @elseif($announcement->section == 5)
                                {{ "A5" }}
                            @elseif($announcement->section == 6)
                                {{ "A6" }}
                            @endif                            
                        </td>
